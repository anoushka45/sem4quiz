...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'vyasanoushka@gmail.com' # this email will be used to send emails
...
EMAIL_RECEIVING_USER = ['vyasanoushka@gmail.com'] # email on which you will receive messages sent from website
